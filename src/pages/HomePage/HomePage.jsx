    ...
    <div className={styles.page}>
      <div className={styles.hello}>
        <div className={styles.left}>
          <div><h1>Самое главное - это здоровье.</h1>
            <div className={styles.rightH1}><img src={hello} alt="img" /></div></div>
      ...
      <div className={styles.about}>
        ...
        <div className={styles.aboutText}>
          ...
          <p className={styles.aboutP}>Мы гордимся тем, что наши специалисты - это высококвалифицированные врачи, которые заботятся о каждом пациенте индивидуально. Они проходят постоянное обучение и обладают самыми современными знаниями и технологиями, чтобы обеспечить вам лучшее лечение.</p>
          <p className={styles.aboutP}>Если вы ищете место, где вас будут лечить с заботой и профессионализмом, то наш Лечебно оздоровительный центр - это именно то место, которое вы искали. Мы готовы помочь вам достичь и поддерживать оптимальное здоровье, и наша дружелюбная команда с нетерпением ждет вас в нашем центре. Свяжитесь с нами, чтобы узнать больше о наших услугах и сделать запись на прием.</p>
          {
            more &&
